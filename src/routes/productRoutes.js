 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/', authenticate, authorize(ROLES.ADMIN), productUpload.array('images', 10), handleMulterError, validate(v.createProduct), auditLog('create', 'Product'), ctrl.createProduct);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.put('/:id', authenticate, authorize(ROLES.ADMIN), productUpload.array('images', 10), handleMulterError, validate(v.updateProduct), auditLog('update', 'Product'), ctrl.updateProduct);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.delete('/:id', authenticate, authorize(ROLES.ADMIN), auditLog('delete', 'Product'), ctrl.deleteProduct);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.delete('/:id/images', authenticate, authorize(ROLES.ADMIN), validate(v.deleteImage), auditLog('delete_image', 'Product'), ctrl.deleteProductImage);
